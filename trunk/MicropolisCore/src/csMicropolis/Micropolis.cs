...
public class Micropolis : IDisposable {
  ...
  public void getHistoryRange(int historyType, int historyScale, out short minValResult, out short maxValResult) {
    micropolisenginePINVOKE.Micropolis_getHistoryRange(swigCPtr, historyType, historyScale, out minValResult, out maxValResult);
  }
  ...
  public void getDemands(out float resDemandResult, out float comDemandResult, out float indDemandResult) {
    micropolisenginePINVOKE.Micropolis_getDemands(swigCPtr, out resDemandResult, out comDemandResult, out indDemandResult);
  }
